    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="  Разработка Продающих сайтов под ключ ✓ Создаем сайты на заказ, выгодные условия от ведущей студии Узбекистана.☆ Мы поможем недорого создать продающий сайт!"/>
            </Head>
