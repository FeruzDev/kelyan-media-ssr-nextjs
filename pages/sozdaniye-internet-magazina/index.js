    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content=" Разработка Интернет-Магазина под ключ ✓ Создаем сайты на заказ, выгодные условия от ведущей студии Узбекистана.☆ Мы поможем недорого создать продающий магазин! "/>
            </Head>
