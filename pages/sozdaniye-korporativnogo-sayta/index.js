    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Разработка Корпоративного Сайта под ключ ✓ Создаем сайты на заказ, выгодные условия от ведущей студии Узбекистана.☆ Мы поможем недорого создать корпоративный сайт  "/>
            </Head>
