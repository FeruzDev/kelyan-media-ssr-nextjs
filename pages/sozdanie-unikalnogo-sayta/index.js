    ...
    return (
        <>
            <Head>
                ...
                <meta name="description" content="Разработка Индивидуальных Проектов под ключ ✓ Создаем сайты на заказ, выгодные условия от ведущей студии Узбекистана.☆ Мы поможем недорого создать уникальный сайт!"/>
            </Head>
