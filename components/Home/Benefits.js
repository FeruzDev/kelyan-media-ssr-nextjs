                    ...
                    <div className="row">
                        ...
                        <div className="col-md-3">
                            <div className="benCard"
                                ...
                                <p>
                                    Настраиваем эффективную стратегию исходя из оптимального для вас бюджета
                                </p>
                        ...
                        <div className="col-md-3">
                            <div className="benCard"
                                ...
                                <p>
                                    Получаем высокие результаты за короткие сроки благодаря грамотным стратегиям и
                                    аналитике на всех этапах работы
                                </p>
                        ...
                        <div className="col-md-3">
                            <div className="benCard"
                                ...
                                <p>
                                    ...
                                    при правильном подходе все это способно повысить ваш имидж и лояльность аудитории.
                                </p>
